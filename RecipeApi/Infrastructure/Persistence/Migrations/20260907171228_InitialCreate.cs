        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedJsonLd = table.Column<string>(type: "jsonb", nullable: true),
                    ...
                    PromotedRecipeId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    RecipeId = table.Column<Guid>(type: "uuid", nullable: false),
                    FavoritedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScrapedPages_Extraction",
                schema: "staging",
                table: "ScrapedPages",
                column: "Extraction");

            migrationBuilder.CreateIndex(
                name: "IX_ScrapedPages_Promotion_ParserVersion",
                schema: "staging",
                table: "ScrapedPages",
                columns: new[] { "Promotion", "ParserVersion" });

            migrationBuilder.CreateIndex(
                name: "IX_ScrapedPages_Url",
                schema: "staging",
                table: "ScrapedPages",
                column: "Url",
                unique: true);
            ...
            // --- Hand-written, not EF-generated ---------------------------------
            // EF Core cannot model gin_trgm_ops, so the trigram indexes are raw SQL.
            // These are what make the ILIKE '%term%' searches in RecipeRepository
            // fast: a B-tree index cannot serve a predicate with a leading wildcard,
            // so without these every ingredient/title search is a sequential scan.
            migrationBuilder.Sql("CREATE EXTENSION IF NOT EXISTS pg_trgm;");

            migrationBuilder.Sql(@"CREATE INDEX ""IX_Ingredients_Name_trgm""
                ON ""Ingredients"" USING GIN (""Name"" gin_trgm_ops);");

            migrationBuilder.Sql(@"CREATE INDEX ""IX_Recipes_Title_trgm""
